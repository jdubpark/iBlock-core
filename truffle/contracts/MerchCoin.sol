 ...
 */
 ...
 contract MerchCoin is Context, ERC20 {
    ...
    enum Users {student, prof, merchAdmin}          // order matters, bc 0 is default in mapping (student)
    ...
    function setUserType(address _address, Users _type) public { //onlyMerchAdmin - TODO add back
    ...
    function transfer(address recipient, uint256 amount) public override onlyMerchAdmin returns (bool) {
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) onlyMerchAdmin public override  returns (bool) {
     ...
     */
    function approve(address spender, uint256 amount) onlyMerchAdmin public override  returns (bool) {
