...
#    RPC_ARG='--ws --wsaddr=0.0.0.0 --wsport 8546 --wsapi=db,eth,net,web3,personal --wsorigins "*" --rpc --rpcaddr=0.0.0.0 --rpcport 8545 --rpcapi=db,eth,net,web3,personal --rpccorsdomain "*"'
    #RPC_ARG='--rpc --rpcaddr=0.0.0.0 --rpcport 8545 --networkid 6797 --rpcapi=db,eth,net,web3,personal --rpccorsdomain "*"'
#RPC_ARG='--http --http.port 8547  --http.addr 0.0.0.0 --http.api personal,eth,net,web3 --rpc --rpcaddr=0.0.0.0 --rpcport 8545 --networkid 6797 --rpcapi=db,eth,net,web3,personal --rpccorsdomain "*"'    
RPC_ARG='--http --http.port 8547  --http.addr=0.0.0.0 --http.api personal,eth,net,web3' 

RPC_PORTMAP="-p $RPC_PORT:8545"
HTTP_PORTMAP="-p 10001:8547"
