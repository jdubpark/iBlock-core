...
// TODO: add ERC20Permit (for permit(), which implements ERC712 & EIP2612 and is used by Uniswap, DAI, etc.)
contract GiesCoin is Context, ERC20 {
    ...
    constructor (uint256 initialSupply, address _adminContractAddress) ERC20("Gies Coin", "GCO") {
