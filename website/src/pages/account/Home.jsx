...
function AuthorizedPage() {
  ...
  const { path } = useRouteMatch() // path = /account
        ...
        <AccountBodyWrapper>
          <Switch>
            ...
            <Route exact sensitive strict path={path}>
              <MyProfile account={userAccount} />
            </Route>
            <Route exact sensitive strict path={`${path}/addresses`}>
              <MyAddresses account={userAccount} addresses={addresses} balances={balances} />
            </Route>
            <Route exact sensitive strict path={`${path}/settings`}>
              <MySettings />
            </Route>
            {/* Catch all other urls & redirect to /account */}
            <Route>
